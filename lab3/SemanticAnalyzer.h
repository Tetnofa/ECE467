...
public:
    ...
    void visitConstantExprNode(ConstantExprNode *constant) override; //DONE
    void visitBoolConstantNode(BoolConstantNode *boolConst) override; //DONE
    void visitIntConstantNode(IntConstantNode *intConst) override; //DONE
