...
public:
  ...
  virtual antlrcpp::Any visitFcnProtoList(smallCParser::FcnProtoListContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitFcnDeclList(smallCParser::FcnDeclListContext *ctx) override {
    return visitChildren(ctx);
  }
