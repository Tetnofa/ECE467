...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitFcnProtoList(smallCParser::FcnProtoListContext *context) = 0;

    virtual antlrcpp::Any visitFcnProto(smallCParser::FcnProtoContext *context) = 0;

    virtual antlrcpp::Any visitFcnDeclList(smallCParser::FcnDeclListContext *context) = 0;
